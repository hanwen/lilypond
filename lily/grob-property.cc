...
Grob::get_property_alist_chain (SCM def) const
{
  ...
  // to create garbage _and_ not expose Mutable_properties.
...
void
Grob::internal_set_value_on_dict (Mutable_properties *dict, SCM sym, SCM v)
{
...
SCM
Grob::try_callback_on_dict (Mutable_properties *dict, SCM sym, SCM proc)
{
