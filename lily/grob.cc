...
Grob::Grob (SCM basicprops)
{
  ...
  smobify_self ();
  mutable_property_dict_ = new Scheme_hash_table ();
  mutable_property_dict_->unprotect ();
  object_dict_ = new Scheme_hash_table ();
  object_dict_->unprotect ();
  ...
  : Smob<Grob> ()
{
  ...
  smobify_self ();
  mutable_property_dict_
    = new Scheme_hash_table (s.mutable_property_dict_->size ());
  object_dict_ = new Scheme_hash_table (5);
  object_dict_->unprotect ();
  mutable_property_dict_->unprotect ();
