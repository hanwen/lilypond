...
*/
void
substitute_object_dict (Scheme_hash_table *orig, Scheme_hash_table *dest)
{
  Scheme_hash_table *fresh = new Scheme_hash_table (dest->size ());
...
void
Grob::substitute_object_links (SCM crit, Scheme_hash_table *orig)
{
